...
parser.add_argument(
    ...
    type=str,
    default="common",
    help="Method used in the evaluation, options=[common, kNN, Holmes]"
)
parser.add_argument(
    "--eval_metrics",
    nargs="+",
...
print("loading test file:", os.path.join(in_path, f"{args.test_file}.npz"))
...
test_X, test_y = data_processor.load_data(
    os.path.join(in_path, f"{args.test_file}.npz"),
    args.feature,
    args.seq_len,
    args.num_tabs
)
